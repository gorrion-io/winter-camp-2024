...
describe('Pagination', () => {
    ...
    it('should update pages when currentPage changes', () => {
        ...
        const { rerender } = render(
            <Pagination currentPage={activePage} maxItems={10} />,
        );

        const currentActiveBtn = screen.getByRole('button', {
            name: activePage.toString(),
        });
        ...
        const nextCurrentActiveBtn = screen.getByRole('button', {
            name: activePage.toString(),
        });
