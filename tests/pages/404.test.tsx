...
describe('404 Page', () => {
	test('renders 404 page with correct content', () => {
		...
		const subHeaderElement = screen.getByText('Oops, your force is not strong enough.');
		expect(subHeaderElement).toBeInTheDocument();

		const firstParagprah = screen.getByText('This page you requested could not be found.');
